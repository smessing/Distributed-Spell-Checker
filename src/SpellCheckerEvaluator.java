...
public class SpellCheckerEvaluator {
	...
	public static enum TestNumber {
		TEST1, TEST2
	};

	public static Iterator<String> getTestErrors(TestNumber num) {
		if (num.equals(TestNumber.TEST1))
			return tests1.keySet().iterator();
		else
			return tests2.keySet().iterator();
	}

	public static double evaluateTest1Corrections(
			Map<String, String> corrections, TestNumber num) {
		...
		for (String error : corrections.keySet()) {
			...
			if (num.equals(TestNumber.TEST1)) {
				correctAnswer = tests1.get(error);
			} else {
				correctAnswer = tests2.get(error);
			}
	...
	public static double evaluateTest2Corrections(
		...
		for (String error : corrections.keySet()) {
			String correctAnswer = tests2.get(error);
			String proposedAnswer = corrections.get(error);
			if (correctAnswer.equals(proposedAnswer))
				correct++;
			count++;
