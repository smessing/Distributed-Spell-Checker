...
public class SpellCheckerEvaluator {
	...
	private static ImmutableMap<String, String> createBigramTest1Map() {
		...
		buildMap.put("as offen", "often");
		buildMap.put("most ofton", "often");
		buildMap.put("always undersand", "understand");
		buildMap.put("he undistand", "understand");
		buildMap.put("is basicaly", "basically");
		buildMap.put("to descide", "decide");
		buildMap.put("a particulaur", "particular");
		buildMap.put("smelled awfall", "awful");
		buildMap.put("an afful", "awful");
		buildMap.put("is neccesary", "necessary");
		buildMap.put("a necesary", "necessary");
		buildMap.put("the neccesary", "necessary");
		buildMap.put("not necassary", "necessary");
		buildMap.put("a necassery", "necessary");
		buildMap.put("is neccasary", "necessary");
		buildMap.put("was uneque", "unique");
		buildMap.put("of conciderable", "considerable");
		buildMap.put("must rember", "remember");
		buildMap.put("you remeber", "remember");
		buildMap.put("he rememmer", "remember");
		buildMap.put("she rermember", "remember");
		buildMap.put("household articals", "articles");
		buildMap.put("detailed acount", "account");
		buildMap.put("she aranged", "arranged");
		buildMap.put("he arrainged", "arranged");
		buildMap.put("this unfortunatly", "unfortunately");
		buildMap.put("highly varable", "variable");
		buildMap.put("the guic", "juice");
		buildMap.put("orange juce", "juice");
		buildMap.put("of jucie", "juice");
		buildMap.put("lemon juise", "juice");
		buildMap.put("the juse", "juice");
		buildMap.put("clear wether", "whether");
		buildMap.put("high leval", "level");
		buildMap.put("were transfred", "transferred");
		buildMap.put("about astablishing", "establishing");
		buildMap.put("about establising", "establishing");
		buildMap.put("will recieve", "receive");
		buildMap.put("the benifit", "benefit");
		buildMap.put("be addresable", "addressable");
		buildMap.put("to remine", "remind");
		buildMap.put("will remined", "remind");
		buildMap.put("a cak", "cake");
		buildMap.put("he fisited", "visited");
		buildMap.put("she viseted", "visited");
		buildMap.put("mockery vistid", "visited");
		buildMap.put("were vistied", "visited");
		buildMap.put("a problam", "problem");
		buildMap.put("the proble", "problem");
		buildMap.put("a promblem", "problem");
		buildMap.put("the proplen", "problem");
		buildMap.put("the biscits", "biscuits");
		buildMap.put("delicious biscutes", "biscuits");
		buildMap.put("dough biscuts", "biscuits");
		buildMap.put("hard bisquits", "biscuits");
		buildMap.put("the buiscits", "biscuits");
		buildMap.put("the buiscuts", "biscuits");
		buildMap.put("she rote", "wrote");
		buildMap.put("he wote", "wrote");
		buildMap.put("beyond compair", "compare");
		buildMap.put("just pertend", "pretend");
		buildMap.put("cannot protend", "pretend");
		buildMap.put("to prtend", "pretend");
		buildMap.put("just pritend", "pretend");
		buildMap.put("a bicycal", "bicycle");
		buildMap.put("her bycicle", "bicycle");
		buildMap.put("his bycycle", "bicycle");
		buildMap.put("to lagh", "laugh");
		buildMap.put("not lauf", "laugh");
		buildMap.put("but laught", "laugh");
		buildMap.put("good lugh", "laugh");
		buildMap.put("almost cirtain", "certain");
		buildMap.put("in receit", "receipt");
		buildMap.put("a receite", "receipt");
		buildMap.put("the reciet", "receipt");
		buildMap.put("a recipt", "receipt");
		buildMap.put("a magnificnet", "magnificent");
		buildMap.put("of magificent", "magnificent");
		buildMap.put("is magnifcent", "magnificent");
		buildMap.put("their magnifecent", "magnificent");
		buildMap.put("a magnifiscant", "magnificent");
		buildMap.put("of magnifisent", "magnificent");
		buildMap.put("is magnificant", "magnificent");
		buildMap.put("of litriture", "literature");
		buildMap.put("the hierachial", "hierarchal");
		buildMap.put("many chalenges", "challenges");
		buildMap.put("he chalenges", "challenges");
		buildMap.put("of exstacy", "ecstasy");
		buildMap.put("the ecstacy", "ecstasy");
		buildMap.put("was descided", "decided");
		buildMap.put("a stomac", "stomach");
		buildMap.put("fat stomache", "stomach");
		buildMap.put("no stomec", "stomach");
		buildMap.put("the stumache", "stomach");
		buildMap.put("not chosing", "choosing");
		buildMap.put("to futher", "further");
		buildMap.put("the questionaire", "questionnaire");
		buildMap.put("very speaical", "special");
		buildMap.put("a specail", "special");
		buildMap.put("by specal", "special");
		buildMap.put("on speical", "special");
